...
function BillingSection() {
  ...
  const subLine = billing
    ? `Property scans are free on every plan. Plan takeoffs use credits — ` +
        ...
        <div className="rounded-lg border border-zinc-200 bg-zinc-50/40 p-4">
          <div className="flex items-baseline justify-between">
            ...
            <span className="text-xs text-zinc-500">
              {isAdmin
                ? "admin account"
                : `of ${total} plan credits remaining`}
            </span>
          </div>
          ...
          <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
            ...
            <Stat label="Plan credits used" value={`${used}`} />
            <Stat
              label="Renews"
              value={
          ...
          {!isAdmin && (
            <div className="mt-4 border-t border-zinc-200 pt-4">
              <div className="microlabel">
                Need more plan takeoffs? Buy credits
              </div>
